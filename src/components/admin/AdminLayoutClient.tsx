...
export default function AdminLayoutClient({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-slate-50/50 overflow-hidden">
            ...
            {/* Sidebar Container */}
            <div className={cn(
                "fixed inset-y-0 left-0 z-[70] w-72 bg-white shadow-2xl md:shadow-none transform transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] md:relative md:translate-x-0 md:w-64",
