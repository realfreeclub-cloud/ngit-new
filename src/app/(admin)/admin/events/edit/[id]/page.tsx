...
import { Save, Calendar, Clock, MapPin, ArrowLeft, Loader2 } from "lucide-react";
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black tracking-tight text-slate-900">Edit Event</h1>
                    <p className="text-slate-500 font-medium">Update the details for this scheduled event.</p>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    <div className="flex gap-4 mb-4">
                        ...
                        <div className="space-y-1 w-48 shrink-0">
                            ...
                            <select
                                className="w-full h-12 border border-slate-200 rounded-xl px-3 bg-white focus:border-primary outline-none text-sm font-bold"
